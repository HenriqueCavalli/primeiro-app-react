...
import avatar from '../../images/avatar_masc.png';
...
const UserProfile = () => (
  <Card>
      ...
      <Row className="center-align">
        <h5 >Henrique Cavalli</h5>
        <p className="grey darken-2 white-text">Web Developer</p>
        <p className="grey darken-1 white-text">Python Developer</p>
        <p className="grey darken-2 white-text">SQL Basic</p>
      </Row>
  </Card>
);
